...
/* handling tabs */
const tabs = document.querySelectorAll(".recipe__image");
/*tabs container */
...
work.addEventListener('click' , function(e){
  ...
  if(clicked==='recipe__image'){
    e.target.classList.add("hide-img");
    document.querySelector(`.${clicked}+#recipe`).classList.add("show-recipe");
  }
})