...
let handleImageClicked = function (e) {
  const clicked = e.target;
  if (
    clicked.classList.value === "recipe__image" ||
    clicked.closest("section").previousElementSibling.classList.value ===
      "recipe__image"
  ) {
    clicked.classList.toggle("hide-img");
    clicked.nextElementSibling.classList.toggle("show-recipe");
  } 
};
work.addEventListener("mouseover", handleImageClicked);
