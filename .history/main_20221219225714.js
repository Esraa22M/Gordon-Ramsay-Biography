...
/*tabs */
const tabs = document.querySelectorAll(".work__card");
...
tabs.forEach(tab=>tab.addEventListener("mouseout", function (e) {
  const clicked = e.target;
  console.log(clicked,"esraa")
  // if (
  //   clicked.closest("section").previousElementSibling.classList.value ===
  //   "recipe__image"
  // ) {
  //       clicked.nextElementSibling.classList.remove("show-recipe");

  //   clicked
  //     .closest("section")
  //     .previousElementSibling.classList.remove("hide-img");
  // }
}))
